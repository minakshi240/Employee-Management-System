...
const AllTask = () => {
  return (
    <div className='bg-[#1c1c1c] p-5 mt-5 h-65 overflow-auto rounded'>
      ...
      <div className='bg-green-300 mb-2 py-2 px-4 flex justify-between rounded'>
        <h2>Minakshi</h2>
        <h3>Make a UI design</h3>
        <h5>Status</h5>
      </div>
      ...
      <div className='bg-amber-400 mb-2 py-2 px-4 flex justify-between rounded'>
        <h2>Minakshi</h2>
        <h3>Make a UI design</h3>
        <h5>Status</h5>
      </div>
